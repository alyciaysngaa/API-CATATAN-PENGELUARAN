...
<body background="img\team.jpg">
    ...
    <div class="content">
        ...
        <div class="faq" id="panel1">Dompet - Qu adalah aplikasi web pencatatan keuangan harian yang mempunyai
            fitur-fitur menarik untuk memonitoring keuangan harian anda. Direkomendasikan bagi para remaja yang
            kesulitan dalam melakukan pengelolaan keuangannya.</div>

        <div class="faq" id="dua">
            <h3>Apa saja fitur Dompet-Qu ?</h3>
            <i class="fas fa-caret-right" style="float: right; font-size: 30px; margin-top:-25px;"></i>
        </div>
        <div class="faq" id="panel2">Dompet - Qu memberikan berbagai yang mempermudah anda untuk mengatur keuangan
            harian anda seperti transaksi harian, rekening pribadi, dan monitoring keuangan berbentuk laporan berjangka
            waktu harian/mingguan/bulanan/tahunan.</div>

        <div class="faq" id="tiga">
            <h3>Bagaimana cara penggunaan Dompet-Qu ?</h3>
            <i class="fas fa-caret-right" style="float: right; font-size: 30px; margin-top:-25px;"></i>
        </div>
        <div class="faq" id="panel3">Pertama anda harus mendaftarkan diri terlebih dahulu. Setelah mendaftarkan diri,
            kita wajib login untuk mengakses aplikasi Dompet-Qu dan anda dapat mengelola keuangan anda secara gratis dan
            tentunya mudah.</div>
    </div>
