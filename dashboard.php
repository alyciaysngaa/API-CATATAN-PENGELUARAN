...
<body>
                            ...
                            <div class="row tampil">
                                <div class="col-lg-5 rek">
                                    <div class="konten-rekening border-right">
                                        ...
                                        <button class="btn btn-lg add-rekening btn-prev" data-toggle="modal"
                                            data-target="#exampleModalCenter"><i class="fas fa-dollar-sign"></i>
    ...
    <script src="keuntungan/js/tambahRekeningIn.js"></script>
    <script src="keuntungan/js/tambahRekeningOut.js"></script>
</body>
