...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top main-nav" id="mainNav">
        <div class="container">
            ...
            <a class="navbar-brand js-scroll-trigger" href="#page-top">WalletQ</a>
    ...
    <header id="home" class="text-light parallax">
        <div class="container konten">
            <h1 style="font-size: 36pt;">Welcome to WalletQ</h1>
            <p class="lead" style="font-size: 16pt;">Aplikasi pencatatan keuangan harian</p>
    ...
    <section id="features" class="bg-light">
        <div class=" container konten2">
            ...
            <div class="col-lg-12 foot-fitur">
                <h4 class="headline text-center">WalletQ</h4>
                <p class="isi-fitur text-center">WalletQ adalah aplikasi web pencatatan keuangan harian yang
                ...
                <div class="col-lg-4">
                    <div class="team">
                        ...
                        <div class="teks">
                            ...
                            <p>Bertujuan untuk memenuhi kebutuhan di waktu yang akan datang serta menyiapkan dana saat
                                ada kejadian tak terduga.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container text-light">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 p-3">
                    <h5> <b>About</b> </h5>
                    <p class="mb-0">Aplikasi Dompet-Qu dilengkapi dengan fitur menarik yang dapat mempermudah user
