...
<head>
    ...
    <title>WalletQ - Pengeluaran</title>
        ...
        <div class="konten khusus2">
            <div class="konten_dalem khusus3">
                    ...
                    <div class="col-lg-5">
                        <table class="tabel-data">
                            <tr>
                                ...
                                <td style="width: 71%"><input type="date" value="<?= $today ?>"
                                        class="form-control filter" id="filter"></td>
                            </tr>
                        </table>
                    ...
                    <div class="col-lg-3">
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <span class="input-group-text bg-white border-left-0 icone"><i
                ...
                <div class="container" id="container">
                                ...
                                <table class="table table-sm table-hover table-striped table-bordered">
                                    ...
                                    <tr class="show" id="<?= $row['id'] ?>">
                                        ...
                                        <td>
                                            ...
                                            <a href="#" data-role="update" class="btn btn-outline-secondary"
                                                id="openBtn" data-id="<?= $row['id'] ?>">
                    ...
                    <button type="button" class="btn btn-primary btn2" data-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="jumlahTambah" class="form-control"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="jumlahKeluar"
                            onkeydown="return numbersonly(this, event);" onkeyup="javascript:tandaPemisahTitik(this);"
                            required>
                    </div>
                </div>
