            ...
            <div class="konten_dalem khusus3">
                ...
                <div class="row">
                    <div class="col-6" style="border-right: 1.45px solid #ccc;">
                        ...
                        <input type="text" value="<?= $dataRekening['id_user'] ?>" class="form-control control"
                            disabled>

                        <p style="margin-top: 18px;">Username</p>
                        <input type="text" value="<?= $dataRekening['username'] ?>" class="form-control control"
                            disabled>
                ...
                <?php 
                    ...
                    if (isset($_POST['transfer'])) {
                        if(transfer($_POST) > 0) {
                            ...
                            // // More headers
                            // $headers .= 'From: WalletQ <noreply@dompetqu.com>'."\r\n" . 'Reply-To : '.$name.' <'.$emailPenerima.'>'."\r\n";
