...
<body>
    ...
    <div class="content">
        <div class="isi mx-auto ">
            ...
            <a class="submit" href="logout" style="margin-left: 600px; text-decoration: none;"><i
                            ...
                            <div class="row">
                                ...
                                <div class="col-7 d-flex align-items-center tulisan">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title ket total"><?= mysqli_num_rows($jumlahUserAktif) ?> User
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-7 d-flex align-items-center tulisan">
                                    <div class="numbers">
                                        ...
                                        <h4 class="card-title ket total"><?= mysqli_num_rows($jumlahUserTidakAktif) ?>
                                            User</h4>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-12" style="margin-top: 20px;">
                <div class="input-group">
                    <input type="text" name="cari" class="form-control border-right-0 cari" id="keyword"
                        placeholder="Search" style="width: 90%;padding: 5px 10px; font-size: 18px;" autocomplete="off">
                    <div class="input-group-append">
                        <span class="input-group-text bg-white border-left-0 icone"><i class="fa fa-search"
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm table-hover table-striped table-bordered">
                            ...
                            <tr id="<?= $row['id_user'] ?>" style="cursor: pointer">
                                <td data-target="id_user" class="data" data-id="<?= $row['id_user'] ?>">
                                    <?= $row['id_user'] ?></td>
                                <td data-target="username" class="data" data-id="<?= $row['id_user'] ?>">
                                    <?= $row['username'] ?></td>
                                <td data-target="email" class="data" data-id="<?= $row['id_user'] ?>">
                                    <?= $row['email'] ?></td>
                                <td data-target="no_rek"><?= $row['no_rek'] ?></td>
                                <td class="data" data-id="<?= $row['id_user'] ?>"><?= $row['level'] ?></td>
                                <td data-target="status" class="data" data-id="<?= $row['id_user'] ?>">
                                    <?= $row['status']?></td>
                                <td>
                                    <button data-id="<?= $row['id_user'] ?>" data-role="update"
                                        class="btn btn-outline-primary openBtn">
