...
<head>
    ...
    <title>WalletQ - Pemasukkan</title>
    ...
    <div class="sidebar">
        <nav>
            <ul>
                ...
                <!-- data -->
                <a href="pengeluaranUser?username=<?= $username ?>&idUser=<?= $idUser ?>"
                ...
                <div class="panel-footer">
                    <nav class="float-right page">
                        <ul class="pagination">
                            ...
                            <li class="page-item">
                                <a href="?halaman=<?= $halamanAktif - 1 ?>&username=<?= $username ?>&idUser=<?= $idUser ?>"
                            ...
                            <li class="page-item active" aria-current="page">
                                <a class="page-link"
                                    href="?halaman=<?= $i; ?>&username=<?= $username ?>&idUser=<?= $idUser ?>"><?= $i; ?></a>
                            </li>
                            <?php else : ?>
